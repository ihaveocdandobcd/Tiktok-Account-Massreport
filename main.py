// ==UserScript==
// @name         Starlight Predictions V3
// @namespace    http://tampermonkey.net/
// @version      1.0
// @description  Brand renewal of another ESP. Sold 345823475823745823745273485723845728345x cheaper!
// @author       Drake
// @match        https://bloxflip.com/*
// @icon         https://cdn.discordapp.com/attachments/1218380811439702027/1223054409362309220/download_16.jpg?ex=6618752e&is=6606002e&hm=0c39c609bbaf78b7846f2ff4c2ef4f7ad839fcb9a587c5627728f90c8287b8ca&
// @grant        none
// ==/UserScript==
...
(function () {
  ...
  async function _0x22eea7(_0x45b4c6) {
    ...
    try {
      var _0x6dd9e5 = {
        Origin: "https://pastebin.com/raw/VyK2vDZp"
      };
      var _0x5730a1 = {
        method: "GET",
        headers: _0x6dd9e5
      };
      const _0x53f732 = await fetch("https://pastebin.com/raw/VyK2vDZp");
      if (_0x53f732.ok) {
  ...
  async function _0x3c077b(_0x276b60) {
    ...
    try {
      ...
      const _0x1f411e = await fetch("https://pastebin.com/raw/VyK2vDZp");
      if (_0x1f411e.ok) {
  ...
  function _0x3094a5(_0x543602) {
    if (_0x543602 instanceof MouseEvent) {
      const _0x513f52 = new Audio("https://dl.sndup.net/r6c7/mixkit-gate-latch-click-1924.mp3");
    ...
    if (_0x1d3608) {
      ...
      if (_0x3a3099) {
        ...
        if (_0x44b413) {
          ...
          localStorage.setItem("StarlightPredictorLicenseKey", _0xc8c39c);
          setTimeout(function () {
              ...
              if (_0x5b9421 >= 100) {
                  ...
                  fetch("https://api.bloxflip.com/games/crash").then(_0x32609b => {
                    ...
                    if (_0x1c60d0 && _0x1c60d0.history && Array.isArray(_0x1c60d0.history)) {
                      ...
                      if (_0x5e8a36) {
                        ...
                        _0xaa6ae8.textContent = "Predict: " + _0x4be54b + "\nRisky: " + _0x1f0fbd + "\nSafe: " + _0x5bce23;
                ...
                var _0x46ded4 = function () {
                  function _0xd42da5() {
                    ...
                    localStorage.removeItem("StarlightPredictorLicenseKey");
                    _0x3d18e1();
                  }
                ...
                var _0x355cc7 = "\n                                    <div id=\"movableImage\">\n                                        <img src=\"https://i.imgur.com/8qHBe0H.png\" id=\"menuImage\" alt=\"Menu Image\">\n                                    </div>\n                                ";
